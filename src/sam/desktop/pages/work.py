"""
Work Page v3.2 — Satu produk.

'What is SAM doing?'
Menggunakan StatusCard, RecommendationCard reusable.
"""
...
class WorkPage(QWidget):
    ...
    def _render(self, model, narratives):
        ...
        for item in model.items[:10]:
            border_map = {
                "failed": "#3a1a1a", "running": "#1a2a3a",
                "Review required": "#3a3a1a", "completed": "#1a3a1a",
            }
            badge_map = {
                "failed": "#e06a6a", "running": "#6aaae0",
                "Review required": "#e0c06a", "completed": "#4ae04a",
            }
            ...
            if item.progress:
                ...
                prog_bar.setStyleSheet("""
                    ...
                    QProgressBar::chunk { background: #2a6a4a; border-radius: 3px; }
                """)
            ...
            if item.approval_needed:
                ...
                approve_frame.setStyleSheet("""
                    QFrame { background: #1a1a0a; border: 1px solid #3a3a1a;
                ...
                approve_btn.setStyleSheet("""
                    QPushButton { background: #2a5a3a; border: none; border-radius: 6px;
                                  padding: 6px 14px; color: #fff; font-size: 12px; font-weight: 500; }
