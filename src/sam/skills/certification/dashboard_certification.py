"""Dashboard Certification Bridge — 5 ExecutionCards (Sprint 170)."""
...
class DashboardCertificationBridge:
    """Bridge dashboard — 5 kartu untuk skill certification."""
    ...
    def cards(self):
        ...
        return [
            ExecutionCard("cert.score", "certification", verdict,
                          f"score {result.score:.0f}/100", "skill score", verdict),
            ...
            ExecutionCard("cert.preview", "certification", "ready",
                          "PreviewOnly passed", "preview", "ready"),
        ]
