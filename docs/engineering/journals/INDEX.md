...
| **Simulation & Preview — bagian Program C 2026-08-07** (SimulationEvidence/Engine/Integration + Preview & Dry Run; add ke ROADMAP) | `journals/2026-08-07_programg-simulation.md` | implementasi Simulation V1 + arah roadmap |
