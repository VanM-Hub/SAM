# docs/engineering/templates — Format Baku
...
## Peran
- Memastikan dokumen baru mengikuti konvensi (metadata: Status/Tanggal/Tipe).
- Tidak menjelaskan isi; hanya kerangka.

## Navigasi
Template → di sini · Contoh jadi → `docs/engineering/` (decisions/reports/journals)
